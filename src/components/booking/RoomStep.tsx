...
export function RoomStep({ startDate, endDate, selectedRoomIds, onToggleRoom }: Props) {
  ...
  if (!startDate || !endDate) {
    return <p className="text-sm text-slate-400">Select dates first to see room availability.</p>
  }

  return (
    <div className="space-y-3">
      <h2 className="text-base font-semibold text-slate-700">Select rooms</h2>
      <p className="text-xs text-slate-500">Select all rooms your group needs. Unavailable rooms are grayed out.</p>
